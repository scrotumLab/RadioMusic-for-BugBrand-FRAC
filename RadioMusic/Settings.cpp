...
void Settings::applySetting(String settingName, String settingValue) {
  ...
  // SLab note set in text file too
  if (settingName.equalsIgnoreCase("setLowNote")) {
    setLowNote = settingValue.toInt();
  }
  
  if (settingName.equalsIgnoreCase("setNoteRange")) {
    setNoteRange = settingValue.toInt();
  }
  
   if (settingName.equalsIgnoreCase("setRootNote")) {
    setRootNote = settingValue.toInt();
  }
...
void Settings::write() {
  ...
  // SLab var now external
  settingsFile.print("setLowNote=");
  settingsFile.println(setLowNote);
  settingsFile.print("setNoteRange=");
  settingsFile.println(setNoteRange);
  settingsFile.print("setRootNote=");
  settingsFile.println(setRootNote);
